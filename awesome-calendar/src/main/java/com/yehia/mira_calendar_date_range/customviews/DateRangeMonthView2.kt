 ...
 */
internal class DateRangeMonthView2 : LinearLayout {
    ...
    private fun initView(context: Context, attributeSet: AttributeSet?) {
        ...
        val mainView = layoutInflater.inflate(layout.layout_calendar_month2, this, true) as LinearLayout
    ...
    companion object {
        private val LOG_TAG = DateRangeMonthView2::class.java.simpleName
    }
}